...
public class Quiz3Activity extends AppCompatActivity {
    ...
    /*    AudienceNetworkAds.initialize(this);
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi3",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi3",MODE_PRIVATE).edit();
        p=preferences.getInt("s3",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf2",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf2",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c3",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong3",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong3",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r3",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Vocabulary Practice 1").child(String.valueOf(p));
