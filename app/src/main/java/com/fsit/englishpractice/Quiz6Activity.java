...
public class Quiz6Activity extends AppCompatActivity {
    ...
    /*    AudienceNetworkAds.initialize(this);
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi6",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi6",MODE_PRIVATE).edit();
        p=preferences.getInt("s6",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf6",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf6",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c6",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong6",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong6",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r6",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Vocabulary Practice 4").child(String.valueOf(p));
