...
public class Quiz2Activity extends AppCompatActivity {
    ...
    /*
      AudienceNetworkAds.initialize(this);
        ...
        */
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi2",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi2",MODE_PRIVATE).edit();
        p=preferences.getInt("s2",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf2",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf2",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c2",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong2",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong2",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r2",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Grammar Practice 2").child(String.valueOf(p));
