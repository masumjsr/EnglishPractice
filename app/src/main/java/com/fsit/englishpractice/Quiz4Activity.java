...
public class Quiz4Activity extends AppCompatActivity {
    ...
    /*    AudienceNetworkAds.initialize(this);
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi4",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi4",MODE_PRIVATE).edit();
        p=preferences.getInt("s4",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf4",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf4",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c4",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong4",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong4",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r4",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Vocabulary Practice 2").child(String.valueOf(p));
