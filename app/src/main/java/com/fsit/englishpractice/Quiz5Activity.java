...
public class Quiz5Activity extends AppCompatActivity {
    ...
    /*    AudienceNetworkAds.initialize(this);
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi5",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi5",MODE_PRIVATE).edit();
        p=preferences.getInt("s5",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf5",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf5",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c5",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong5",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong5",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r5",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Vocabulary Practice 3").child(String.valueOf(p));
