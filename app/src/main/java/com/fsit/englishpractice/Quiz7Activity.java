...
public class Quiz7Activity extends AppCompatActivity {
    ...
    /*    AudienceNetworkAds.initialize(this);
       ...
       // Place the ad view.
        ...
        // quiz  preferences
        preferences=getSharedPreferences("rabbi7",MODE_PRIVATE);
        edit=getSharedPreferences("rabbi7",MODE_PRIVATE).edit();
        p=preferences.getInt("s7",0);

        // correct preferences
        preferencesj7=getSharedPreferences("correctf7",MODE_PRIVATE);
        editk7=getSharedPreferences("correctf7",MODE_PRIVATE).edit();
        correct=preferencesj7.getInt("c7",0);

        // wrong preferences
        preferencesl7=getSharedPreferences("wrong7",MODE_PRIVATE);
        editm7=getSharedPreferences("wrong7",MODE_PRIVATE).edit();
        wrong=preferencesl7.getInt("r7",0);
    ...
    public  void updatequestion(){
        ...
        if(p<=100)
        {
            reference= FirebaseDatabase.getInstance().getReference().child("Vocabulary Practice 5").child(String.valueOf(p));
